...
var backgroundAudio = new Audio('background.mp3');
var launchAudio = new Audio('launch.mp3');
...
function finishLaunch() {  // complete the launch sequence
    // stop background audio and play launch sound effect when launch is done
